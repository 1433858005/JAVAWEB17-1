package heimaxueshnegxitonga3.service;
import heimaxueshnegxitonga3.dao.OtherStudentDao;
import heimaxueshnegxitonga3.dao.StudentDao;
...
//判断id是否被占用
    ...
    public heimaxueshnegxitonga3.domain.Student[] findAllStudent() {
        heimaxueshnegxitonga3.domain.Student[] allStudent =studentDao.findAllStudent();
        boolean flag =false;
        for (int i = 0; i < allStudent.length; i++) {
            heimaxueshnegxitonga3.domain.Student stu=allStudent[i];
            if (stu!=null){
                flag =true;
                break;
            }
